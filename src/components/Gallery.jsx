...
const Gallery = () => {
  return (
    <section className='bg-primary p-4 lg:p-8' id="gallery">
      <h2 className='text-white text-3xl font-monoton mb-2'>CR7 IN ACTION</h2>
      <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 xl:grid-cols-7 gap-4'>
        <img className='rounded-lg h-56 w-52 object-cover' src="https://wallpapercave.com/wp/wp11239789.jpg" alt="" />
        <img className='rounded-lg h-56 w-52 object-cover' src="https://wallpapercave.com/wp/wp11239802.jpg" alt="" />
        ...
        <img className='rounded-lg h-56 w-52 object-cover' src="https://s.hs-data.com/picmon/1b/2GTc_122vEg_l.jpg" alt="" />
